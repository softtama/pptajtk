...
<html>
	...
	<body>
		...
		<div class="container flex-container">
			...
			<div class="row">
				<div class="col-md-6">
					<input id='btn_addnew' class="btn btn-primary" name='btn_addnew' type="button" value="Upload Dokumen Analisis dan SRS" data-toggle="modal" data-target="#modalUploadDokumenProposal" />
				</div>
				<div class="col-md-6" align="right">
					<input id='btn_addnew' class="btn btn-danger" name='btn_addnew' type="button" value="Hapus Dokumen" onclick="location.href='<?php echo base_url(); ?>c_mengelolaSeminarDua/hapusDokumenAnlSRS'" />
				</div>
			</div>
			<br>
