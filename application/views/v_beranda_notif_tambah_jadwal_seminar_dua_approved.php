		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Pengelolaan Seminar / Seminar 2 / Persetujuan Jadwal Seminar 2</h4>
				</div>
				<div class="panel-body">
					...
					<div style="margin: 10px 0;">telah dicermati oleh Pembimbing I, Joe Lian Min, dan jadwal tersebut <h4 style="display: inline; margin-bottom: 0; margin-top: 0;"><span class="label label-success">DISETUJUI</span></h4>.</div>
					<div style="margin-top: 10px;">Harap segera mempublikasikan jadwal ini ke Kelompok TA yang bersangkutan.</div>
				</div>
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh sistem, pada Kamis, 30 April 2015, 11.20 WIB</div>
					</div>
				</div>
			</div>
		</div>
