		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Pengelolaan Seminar / Seminar 3 / Penambahan Jadwal Seminar 3</h4>
				</div>
				<div class="panel-body">
					...
					<p style="margin: 10px 0;">telah dibuat oleh Koordinator Santi Sundari, dengan detail sebagai berikut:</p>
					<form class="form-horizontal">
						<div class="form-group" style="margin-bottom: 0;">
					...
					<div style="margin-top: 10px;">Status jadwal pelaksanaan Seminar 3 KOTA 108 ini masih <h4 style="display: inline; margin-bottom: 0; margin-top: 0;"><span class="label label-warning">PENDING</span></h4> menunggu persetujuan dari Pembimbing I, Joe Lian Min.</div>
				</div>
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh Santi Sundari, pada Jumat, 29 Mei 2015, 10.00 WIB</div>
					</div>
				</div>
			</div>
		</div>
