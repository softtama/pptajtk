			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal">
						...
						<div class="form-group" style="margin-bottom: 0;">
							<label class="col-md-3 control-label" style="text-align: left;">Pembimbing 1</label>
							<div class="col-md-7">
								<p id='vd_id_kota' class="form-control-static">Joe Lian Min</p>
							</div>
						</div>
						<div class="form-group" style="margin-bottom: 0;">
							<label class="col-md-3 control-label" style="text-align: left;">Pembimbing 2</label>
							<div class="col-md-7">
