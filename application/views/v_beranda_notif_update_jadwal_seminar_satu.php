...
<html>
	...
	<body>
		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Pengelolaan Seminar / Seminar 1 / Perubahan Jadwal Seminar 1</h4>
				</div>
				<div class="panel-body">
					...
					<p style="margin: 10px 0;">telah diperbarui oleh Ida Suhartini, dengan detail sebagai berikut:</p>
					<form class="form-horizontal">
						<div class="form-group" style="margin-bottom: 0;">
							<label class="col-md-2 control-label" style="text-align: left;">Data Awal Jadwal</label>
							<div class="col-md-8">
						...
						<div class="form-group" style="margin-bottom: 0;">
							<label class="col-md-2 control-label" style="text-align: left;">Data Terkini Jadwal</label>
							<div class="col-md-8">
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh Ida Suhartini, pada Jumat, 27 Februari 2015, 14.00 WIB</div>
					</div>
				</div>
			</div>
		</div>

		<!-- Modal Lihat Data Awal Jadwal Seminar 1 -->
		<div class="modal fade" id="modalLihatDataAwalKOTAtemp" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Data Awal Jadwal Seminar 1</h4>
					</div>
					<div class="modal-body">
						<form class="form-horizontal">
							...
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Tanggal Seminar</label>
								<div class="col-md-8">
									<p id='vd_id_kota' class="form-control-static">Senin, 2 Maret 2015</p>
								</div>
							</div>
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Jam Seminar</label>
								<div class="col-md-8">
									<p id='vd_id_kota' class="form-control-static">08.40 WIB</p>
								</div>
							</div>
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Ruangan Seminar</label>
								<div class="col-md-8">
									<p id='vd_id_kota' class="form-control-static">Ruang A201</p>
								</div>
							</div>
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Penguji Seminar</label>
								<div class="col-md-8">
									<p id='vd_id_kota' class="form-control-static">Santi Sundari; Suprihanto</p>
								</div>
							</div>
						</form>
					</div>
		...
		<!-- Modal Lihat Data Terkini Jadwal Seminar 1 -->
		<div class="modal fade" id="modalLihatDataBaruKOTAtemp" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Data Terkini Jadwal Seminar 1</h4>
					</div>
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="form-group" style="margin-bottom: 0;">
							...
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Tanggal Seminar</label>
								<div class="col-md-8">
									<p id='vd_id_kota' class="form-control-static">Senin, 9 Maret 2015</p>
								</div>
							</div>
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Jam Seminar</label>
							...
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Ruangan Seminar</label>
								<div class="col-md-8">
									<p id='vd_id_kota' class="form-control-static">Ruang A202</p>
								</div>
							</div>
							<div class="form-group" style="margin-bottom: 0;">
								<label class="col-md-4 control-label" style="text-align: left;">Penguji Seminar</label>
