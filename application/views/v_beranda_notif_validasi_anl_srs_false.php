		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Pengelolaan Seminar / Seminar 2 / Validasi Dokumen Analisis dan SRS Tugas Akhir</h4>
				</div>
				<div class="panel-body">
					<p>Dokumen Analisis dan SRS Tugas Akhir milik</p>
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<p id='vd_id_kota' class="form-control-static">Kamis, 30 April 2015, 09.00 WIB <a href="#">(Unduh Dokumen)</a></p>
							</div>
						</div>
					</form>
					telah divalidasi oleh Koordinator Santi Sundari dengan status <h4 style="display: inline-block; margin-bottom: 0; margin-top: 0;"><span class="label label-danger">TIDAK LAYAK</span></h4> untuk melaksanakan Seminar 2.
				</div>
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh Santi Sundari, pada Kamis, 30 April 2015, 10.20 WIB</div>
					</div>
				</div>
			</div>
		</div>
