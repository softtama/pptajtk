		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					telah divalidasi oleh Santi Sundari dengan status <h4 style="display: inline-block; margin-bottom: 0; margin-top: 0;"><span class="label label-danger">TIDAK LAYAK</span></h4> untuk melaksanakan Seminar 2.
				</div>
