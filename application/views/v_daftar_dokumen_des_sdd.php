	...
	<body>
		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="alert alert-success" role="alert">
				...
				<strong>Validasi dokumen Desain dan SDD KOTA 101 dengan status LAYAK berhasil dilakukan!</strong>
			...
			<div class="alert alert-danger" role="alert">
				...
				<strong>Validasi dokumen Desain dan SDD KOTA 101 dengan status LAYAK gagal dilakukan!</strong> Silakan coba lagi.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Validasi dokumen Desain dan SDD KOTA 101 dengan status TIDAK LAYAK berhasil dilakukan!</strong>
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-danger" role="alert">
				<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
				<span class="sr-only">Error:</span>
				<strong>Validasi dokumen Desain dan SDD KOTA 101 dengan status TIDAK LAYAK gagal dilakukan!</strong> Silakan coba lagi.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Perubahan status dokumen Desain dan SDD KOTA 106 dari TIDAK LAYAK menjadi LAYAK berhasil dilakukan!</strong>
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Perubahan status dokumen Desain dan SDD KOTA 106 dari TIDAK LAYAK menjadi LAYAK gagal dilakukan!</strong> Silakan coba lagi.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Perubahan status dokumen Desain dan SDD KOTA 108 dari LAYAK menjadi TIDAK LAYAK berhasil dilakukan!</strong>
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Perubahan status dokumen Desain dan SDD KOTA 108 dari LAYAK menjadi TIDAK LAYAK gagal dilakukan!</strong> Silakan coba lagi.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			<?php } ?>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Detail Dokumen Desain dan SDD</h4>
					</div>
					<div class="modal-body">
						<form id="form_detail_proposal" class="form-horizontal" name="form_detail_proposal">
							...
							<div class="form-group">
								<h4><label class="col-sm-12 control-label" style="text-align: left;">History Upload Dokumen Desain dan SDD</label></h4>
							</div>
							<div class="form-group">
								<div class="col-sm-12">
		...
		<div class="modal fade" id="modalKonfirmasiValidasiProposal_101" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Konfirmasi Validasi Dokumen Desain dan SDD TA</h4>
					</div>
					<div class="modal-body" style="text-align: center;">
						<p>Apakah Anda yakin ingin memvalidasi<br>dokumen Desain dan SDD Kelompok TA 101 ini<br>sebagai dokumen yang layak untuk melaksanakan Seminar 2?</p>
					...
					<div class="modal-footer">
						<div class="col-sm-6" style="text-align: left;">
							<a href="<?php echo base_url().'c_mengelolaSeminarTiga/validate_yes' ?>" class="btn btn-success">Ya, Layak</a>
							<a href="<?php echo base_url().'c_mengelolaSeminarTiga/validate_no' ?>" class="btn btn-danger">Tidak Layak</a>
						</div>
						<div class="col-sm-6">
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						</div>
		...
		<div class="modal fade" id="modalKonfirmasiValidasiProposal_106" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: center;">
						<p>Anda sudah memberi status TIDAK LAYAK pada dokumen Desain dan SDD ini sebelumnya.</p>
						<p>Apakah Anda yakin ingin memvalidasi<br>dokumen Desain dan SDD Kelompok TA 106 ini<br>sebagai dokumen yang layak untuk melaksanakan Seminar 2?</p>
						<form id="validasi_dok_proposal" class="form-horizontal" name="validasi_dok_proposal">
							<div class="form-group hide">
								<div class="col-sm-offset-4 col-sm-8">
					...
					<div class="modal-footer">
						<div class="col-sm-6" style="text-align: left;">
							<a href="<?php echo base_url().'c_mengelolaSeminarTiga/update_yes' ?>" class="btn btn-success">Ya, Layak</a>
		...
		<div class="modal fade" id="modalKonfirmasiValidasiProposal_108" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: center;">
						<p>Anda sudah memberi status LAYAK pada dokumen Desain dan SDD ini sebelumnya.</p>
						<p>Apakah Anda yakin ingin memvalidasi<br>dokumen Desain dan SDD Kelompok TA 108 ini<br>sebagai dokumen yang layak untuk melaksanakan Seminar 2?</p>
						<form id="validasi_dok_proposal" class="form-horizontal" name="validasi_dok_proposal">
							<div class="form-group hide">
								<div class="col-sm-offset-4 col-sm-8">
					...
					<div class="modal-footer">
						<div class="col-sm-6" style="text-align: left;">
							...
							<a href="<?php echo base_url().'c_mengelolaSeminarTiga/update_no' ?>" class="btn btn-danger">Tidak Layak</a>
						</div>
						<div class="col-sm-6">
							<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						</div>
