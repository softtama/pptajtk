...
<html>
	...
	<body>
		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Pengelolaan Seminar / Seminar 3 / Perubahan Jadwal Seminar 3</h4>
				</div>
		...
		<!-- Modal Lihat Data Awal Jadwal Seminar 3 -->
		<div class="modal fade" id="modalLihatDataAwalKOTAtemp" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Data Awal Jadwal Seminar 3</h4>
					</div>
		...
		<!-- Modal Lihat Data Terkini Jadwal Seminar 3 -->
		<div class="modal fade" id="modalLihatDataBaruKOTAtemp" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Data Terkini Jadwal Seminar 3</h4>
					</div>
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="form-group" style="margin-bottom: 0;">
