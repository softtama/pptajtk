			...
			<ul class="nav navmenu-nav">
				...
				<li class="active">
					...
					<ul class="dropdown-menu navmenu-nav" role="menu">
						...
						<li class="active"><a href="<?php echo base_url().'c_mengelolaSeminarSatu/uploadDokumenProposal' ?>">Upload Dokumen Proposal</a></li>
		...
		<div class="container flex-container">
			...
			<div class="row">
				...
				<div class="col-md-6" align="right">
					<input id='btn_addnew' class="btn btn-danger" name='btn_addnew' type="button" value="Hapus Dokumen" onclick="location.href='<?php echo base_url(); ?>c_mengelolaSeminarSatu/hapusDokumenProposal'" />
				</div>
			</div>
			<br>
			<div class="alert alert-warning" role="alert">
				...
				<strong>Kelompok Anda belum mengunggah berkas dokumen proposal!</strong> Silakan upload sebagai persyaratan Seminar 1.
			</div>
