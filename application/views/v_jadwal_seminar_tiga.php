			...
			<ul class="nav navmenu-nav">
				...
				<li class="active">
					...
					<ul class="dropdown-menu navmenu-nav" role="menu">
						...
						<li class="active"><a href="<?php echo base_url().'c_mengelolaSeminarTiga/lihatJadwalSeminarTiga' ?>">Jadwal Seminar 3</a></li>
				...
				<div class="col-md-12" style="text-align: center;">
					<nav>
						<ul class="pagination" style="margin: 0;">
							...
							<li><a href="#">Mei</a></li>
							<li class="active"><a href="#">Juni</a></li>
							<li><a href="#">Juli</a></li>
							<li>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah Jadwal Seminar 3</h4>
					</div>
		...
		<div class="modal fade" id="modalViewDetailJadwalSeminar_108" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Detail Jadwal Seminar 3</h4>
					</div>
					<div class="modal-body">
						<form id="form_viewdet_kota" class="form-horizontal" name="form_viewdet_kota">
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">Topik Tugas Akhir</label>
								<div class="col-md-8">
		...
		<div class="modal fade" id="modalEditJadwalSeminarSatu" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Edit Jadwal Seminar 3</h4>
					</div>
					<div class="modal-body">
						<form id="form_viewdet_kota" class="form-horizontal" name="form_viewdet_kota">
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class='input-group date' id='input-date-picker'>
					                    <input id='input-date' name='input-date' type='text' class="form-control" value="25/06/2015" />
					                    <span class="input-group-addon">
					                        <span class="glyphicon glyphicon-calendar"></span>
					                    </span>
					                </div>
