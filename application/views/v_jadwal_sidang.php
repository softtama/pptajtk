				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="form_viewdet_kota" class="form-horizontal" name="form_viewdet_kota">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">Ruangan Sidang</label>
								<div class="col-md-6">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">Penguji Sidang</label>
								<div class="col-md-6">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="form_viewdet_kota" class="form-horizontal" name="form_viewdet_kota">
							...
							<div class="form-group">
								<label class="col-md-4 control-label">Jam Sidang</label>
								<div class="col-md-6">
