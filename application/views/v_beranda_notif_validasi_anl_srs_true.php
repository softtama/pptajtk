		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<p id='vd_id_kota' class="form-control-static">Rabu, 29 April 2015, 08.00 WIB <a href="#">(Unduh Dokumen)</a></p>
							</div>
						</div>
					</form>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh Santi Sundari, pada Kamis, 30 April 2015, 10.15 WIB</div>
					</div>
				</div>
			</div>
		</div>
