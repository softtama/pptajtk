		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Pengelolaan Seminar / Seminar 2 / Publikasi Jadwal Seminar 2</h4>
				</div>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh Ida Suhartini, pada Jumat, 1 Mei 2015, 10.00 WIB</div>
					</div>
				</div>
			</div>
		</div>
