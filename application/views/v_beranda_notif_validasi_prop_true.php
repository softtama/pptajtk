				...
				<div class="panel-body">
					...
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<p id='vd_id_kota' class="form-control-static">Jumat, 27 Februari 2015, 08.00 WIB <a href="#">(Unduh Dokumen)</a></p>
							</div>
						</div>
					</form>
					telah divalidasi oleh Koordinator Santi Sundari dengan status <h4 style="display: inline-block; margin-bottom: 0; margin-top: 0;"><span class="label label-success">LAYAK</span></h4> untuk melaksanakan Seminar 1.
				</div>
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">Dipublikasikan oleh Santi Sundari, pada Jumat, 27 Februari 2015, 13.30 WIB</div>
					</div>
				</div>
			</div>
		</div>
