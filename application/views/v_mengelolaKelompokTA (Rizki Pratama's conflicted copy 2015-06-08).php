			...
			<table class="table table-hover">
				...
				<?php foreach ($list_detail_kota as $value_ldk) { ?>
					...
					$idx++; 
						...
						<td><a href="#" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalViewDetailKelompokTA"><span class="glyphicon glyphicon-info-sign"></span></a></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>

			<?php print_r($list_detail_kota); ?>
							...
							<form id="form_create_kota" name="form_create_kota" class="form-signin" action='c_mengelolaKelompokTA/inputKelompokTA' method='post'>
								<table>
									...
									<tr>
										...
										<td>
											<input id='vd_anggota_1' class="form-control" name='anggota_1' type="text" />
										</td>
									</tr>
									<tr> 
										<td><label for='vd_anggota_2'>Anggota 2</label></td>
										<td>
											<input id='vd_anggota_2' class="form-control" name='anggota_2' type="text" />
										</td>
									</tr>
									<tr> 
										<td><label for='vd_anggota_3'>Anggota 3</label></td>
										<td>
											<input id='vd_anggota_3' class="form-control" name='anggota_3' type="text" />
										</td>
									</tr>
									<tr> 
