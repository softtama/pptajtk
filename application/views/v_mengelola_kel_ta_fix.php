	...
	<body>
		...
		<div class="container flex-container container-below-navbar-fixed-top">
			...
			<div class="alert alert-success" role="alert">
				...
				<strong>Data Kelompok TA berhasil dibuat!</strong> Silakan lanjutkan penambahan data Kelompok TA lainnya, atau lakukan kegiatan lainnya.
			...
			<div class="alert alert-danger" role="alert">
				...
				<strong>Data Kelompok TA gagal dibuat!</strong> Silakan coba lagi, atau lakukan kegiatan lainnya.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Data Kelompok TA berhasil diperbarui!</strong> Silakan lanjutkan perubahan data Kelompok TA lainnya, atau lakukan kegiatan lainnya.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-danger" role="alert">
				<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Data Kelompok TA gagal diperbarui!</strong> Silakan coba lagi, atau lakukan kegiatan lainnya.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Data Kelompok TA berhasil dihapus!</strong> Silakan lanjutkan penghapusan data Kelompok TA lainnya, atau lakukan kegiatan lainnya.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-danger" role="alert">
				<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Data Kelompok TA gagal dihapus!</strong> Silakan coba lagi, atau lakukan kegiatan lainnya.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-success" role="alert">
				<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
				<span class="sr-only">Success:</span>
				<strong>Data Kelompok TA berhasil dipublikasikan!</strong> Jangan lupa untuk melakukan publikasi setiap ada penambahan dan perubahan data.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			...
			<div class="alert alert-danger" role="alert">
				...
				<strong>Data Kelompok TA gagal dipublikasikan!</strong> Silakan coba lagi, atau lakukan kegiatan lainnya.
				<button type="button" class="close" data-dismiss="alert" data-toggle="tooltip" data-placement="top" title="Tutup" style="margin-top: -2px;">&times;</button>
			</div>
			<?php } ?>
			...
			<div class="row">
				...
				<div class="col-md-6" align="right">
					<a href="#" id='btn_addnew' class="btn btn-success" name='btn_publish' type="button" data-toggle="modal" data-target="#modalPublikasiDataKelompokTA">
		...
		<!-- Modal for Publish -->
		<div class="modal fade" id="modalPublikasiDataKelompokTA" role="dialog">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Publikasi Data Kelompok TA</h4>
					</div>
					<div class="modal-body" style="text-align: center;">
